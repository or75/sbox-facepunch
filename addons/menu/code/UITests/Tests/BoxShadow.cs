...
namespace Sandbox.UI.Tests
{
	public class BoxShadow : Panel
	{
		public BoxShadow()
		{
			...
			AddTest( "0px 0px 10px yellow" );
			AddTest( "0px 0px 25px yellow" );
			AddTest( "0px 0px 50px yellow" );
			AddTest( "0px 0px 100px yellow" );
			AddTest( "0px 0px 200px yellow" );

			AddTest( "0px 0px 30px yellow, 0px 0px 10px red; border-radius: 1000px" );
		...
		private void AddTest( string v )
		{
			var p = Add.Label( v );
			p.Style.Set( $"box-shadow: {v}; background-color: white; padding: 20px; margin: 30px;" );
		}
	}
}
