...
namespace Sandbox.UI.Tests
{
	public class BorderImages : Panel
	{
		public BorderImages()
		{
			...
			AddTest( "This is a box with a border around it", "border-image: url( /ui/tests/border-diamonds.png ) 30;" );
			AddTest( "This is a box with a border around it", "border-image: url( /ui/tests/border-diamonds.png ) 30 / 19px round;" );
			AddTest( "This is a box with a border around it", "border-image: url( /ui/tests/border-diamonds.png ) 30 / 36px fill round;" );

			AddTest( "This is a box with a border around it", "border-image: url( /ui/tests/border-diamonds.png ) 60 / 60;" );

			// https://i.imgur.com/164m8Pw.png
			AddTest( "This element is surrounded by a bitmap-based border-image!", "border-image: url( /ui/tests/border-diamonds.png ) 30 / 36px 28px 18px 8px round;" );
			...
			AddTest( "Masked Man:\nOr perhaps he's wondering, why would someone shoot a man, before throwing him out of a plane?",
					 ...
					 "border-image: url( /ui/tests/border-ff.png ) 30  round;" 
					 );
