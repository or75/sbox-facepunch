...
namespace Sandbox
{
	public class PawnController : BaseNetworkable
	{
		...
		public Rotation EyeRot { get; set; }
		public Vector3 EyePosLocal { get; set; }
		...
		[System.Obsolete] public Vector3 Pos => Position;
		[System.Obsolete] public Rotation Rot => Rotation;
		...
		public void UpdateFromEntity( Entity entity )
		{
			...
			EyeRot = entity.EyeRot;
			EyePosLocal = entity.EyePosLocal;
		...
		public void Finalize( Entity target )
		{
			...
			target.EyePosLocal = EyePosLocal;
			target.EyeRot = EyeRot;
		}
