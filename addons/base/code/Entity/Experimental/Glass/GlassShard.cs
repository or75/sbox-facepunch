...
namespace Sandbox
{
	...
	[Library( "glass_shard" )]
	[Hammer.Skip]
	[Display( Name = "Glass Shard" ), Icon( "play_arrow" )]
	public partial class GlassShard : ModelEntity
	{
		...
		public override void TakeDamage( DamageInfo info )
		{
			...
			ShatterWorldSpace( info.Position );
		}
		...
		public override void Touch( Entity other )
		{
			...
			// This is all shit but it does the job for now

			Unfreeze();
			StressVelocity = other.Velocity * 0.5f;

			if ( CalculateArea() > 1500.0f )
			{
				ShatterTypeIndex = 0;
		...
		public void Freeze()
		{
			...
			SetInteractsWith( CollisionLayer.All );
		...
		public void Unfreeze()
		{
			...
			// If it's a big piece, do not make it debris
			if ( IsABigPiece() || ParentPanel.NumShards == 1 )
			{
				CollisionGroup = CollisionGroup.Default;
		...
		public void ShatterLocalSpace( Vector2 position )
		{
			if ( !IsAuthority )
				return;
