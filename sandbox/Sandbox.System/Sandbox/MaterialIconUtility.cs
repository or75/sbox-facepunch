...
namespace Sandbox
{
	...
	{
		// Token: 0x060003BF RID: 959 RVA: 0x0000DF9C File Offset: 0x0000C19C
		public static MaterialIcon Lookup(string name)
		{
			int icon;
			if (MaterialIconUtility.ValueToIcon.TryGetValue(name, out icon))
			{
				return (MaterialIcon)icon;
			}
			return MaterialIcon.InvalidIcon;
		}

		// Token: 0x060003C0 RID: 960 RVA: 0x0000DFBC File Offset: 0x0000C1BC
		public static string Lookup(MaterialIcon icon)
		{
			string name;
			if (MaterialIconUtility.IconToValue.TryGetValue((int)icon, out name))
			{
				return name;
			}
			return null;
		...
		private static Dictionary<int, string> IconToValue = new Dictionary<int, string>
		{
			{ 59729, "10k" },
			{ 59730, "10mp" },
			{ 59731, "11mp" },
		...
		private static Dictionary<string, int> ValueToIcon = new Dictionary<string, int>
		{
			{ "10k", 59729 },
			{ "10mp", 59730 },
			{ "11mp", 59731 },
